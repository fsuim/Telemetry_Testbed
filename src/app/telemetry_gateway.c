#include "app/telemetry_gateway.h"

#include "infra/db_sqlite.h"
#include "infra/mqtt_client.h"
#include "domain/telemetry_types.h"
#include "domain/telemetry_topics.h"
#include "infra/ws_server.h"
...
static void on_message(struct mosquitto *mosq, void *ud, const struct mosquitto_message *msg){
    ...
    if(strcmp(msg->topic, TELEMETRY_TOPIC_STATE) != 0) return;
...
int telemetry_gateway_start(telemetry_gateway_t **out,
    ...
    mosquitto_subscribe(g->mqtt.mosq, NULL, TELEMETRY_TOPIC_STATE, 0);

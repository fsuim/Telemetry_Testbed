...
static void *motor1_thread(void *arg){
    ...
    while(*(a->rt.running)){
        ...
        publish_or_log(cli.mosq, TELEMETRY_TOPIC_MOTOR1_TICS, payload_tics, (int)sizeof(payload_tics), "MOTOR1");
        publish_or_log(cli.mosq, TELEMETRY_TOPIC_MOTOR1_RPM, payload_rpm, (int)sizeof(payload_rpm), "MOTOR1");
        publish_or_log(cli.mosq, TELEMETRY_TOPIC_MOTOR1_TEMP, payload_temp, (int)sizeof(payload_temp), "MOTOR1");
        publish_or_log(cli.mosq, TELEMETRY_TOPIC_MOTOR1_VPS, payload_vps, (int)sizeof(payload_vps), "MOTOR1");
        publish_or_log(cli.mosq, TELEMETRY_TOPIC_MOTOR1_CPS, payload_cps, (int)sizeof(payload_cps), "MOTOR1");

...
#include "util/pack_le.h"
#include "util/time_utils.h"
#include "domain/telemetry_topics.h"
...
static void *motor2_thread(void *arg){
    ...
    while(*(a->rt.running)){
        ...
        publish_or_log(cli.mosq, TELEMETRY_TOPIC_MOTOR2_TICS, payload_tics, (int)sizeof(payload_tics), "MOTOR2");
        publish_or_log(cli.mosq, TELEMETRY_TOPIC_MOTOR2_RPM, payload_rpm, (int)sizeof(payload_rpm), "MOTOR2");
        publish_or_log(cli.mosq, TELEMETRY_TOPIC_MOTOR2_TEMP, payload_temp, (int)sizeof(payload_temp), "MOTOR2");
        publish_or_log(cli.mosq, TELEMETRY_TOPIC_MOTOR2_VPS, payload_vps, (int)sizeof(payload_vps), "MOTOR2");
        publish_or_log(cli.mosq, TELEMETRY_TOPIC_MOTOR2_CPS, payload_cps, (int)sizeof(payload_cps), "MOTOR2");
